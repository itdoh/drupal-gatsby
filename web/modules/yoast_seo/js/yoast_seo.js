...
YoastSEO_DrupalSource.prototype.getDataFromInput = function (field) {
  ...
  if (this.config.fields[field] instanceof Array) {
    ...
    value = this.config.fields[field] ? document.getElementById(this.config.fields[field]).value : null;
  }
...
YoastSEO_DrupalSource.prototype.tokenReplace = function (value) {
  var self = this,
    tokenRegex = /(\[[^\]]*:[^\]]*\])/g,
    match = value ? value.match(tokenRegex) : null,
    tokensNotFound = [];
